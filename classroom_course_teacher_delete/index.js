module.exports = function (context, data) {
    ...
    var message = '';
    var event_type = "ca.wrdsb.igor.google_classroom_course_teacher.delete";
    var flynn_event = {
        eventID: `${event_type}-${context.executionContext.invocationId}`,
        eventType: event_type,
        source: ``,
        schemaURL: "https://mcp.wrdsb.io/schemas/igor/classroom/course/teacher_delete-event.json",
        extensions: {
            label: "",
            tags: [
            ]
